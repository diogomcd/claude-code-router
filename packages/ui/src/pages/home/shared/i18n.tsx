...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "CCR scanned this computer for Antigravity, Claude Code, Codex, Grok CLI, OpenCode CLI, and ZCode login states. Click Import to add one as a gateway provider.": "CCR scanned this computer for Antigravity, Claude Code, Codex, Grok CLI, OpenCode CLI, and ZCode login states. Click Import to add one as a gateway provider.",
      "Detected": "Detected",
      ...
      "Antigravity login detected. Click Import to add it as a gateway provider.": "Antigravity login detected. Click Import to add it as a gateway provider.",
      ...
      "CCR scanned this computer for local Antigravity, Claude Code, Codex, Grok CLI, Kimi CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.": "CCR scanned this computer for local Antigravity, Claude Code, Codex, Grok CLI, Kimi CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.",
      "Locked": "Locked",
      "Manual": "Manual",
  ...
  zh: {
    ...
    text: {
      ...
      "Description": "描述",
      "CCR scanned this computer for Antigravity, Claude Code, Codex, Grok CLI, OpenCode CLI, and ZCode login states. Click Import to add one as a gateway provider.": "CCR 已扫描本机的 Antigravity、Claude Code、Codex、Grok CLI、OpenCode CLI 和 ZCode 登录态。点击导入即可添加为网关供应商。",
      ...
      "Antigravity login detected. Click Import to add it as a gateway provider.": "已检测到 Antigravity 登录态。点击导入即可添加为网关供应商。",
      ...
      "CCR scanned this computer for local Antigravity, Claude Code, Codex, Grok CLI, Kimi CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.": "CCR 已扫描本机的 Antigravity、Claude Code、Codex、Grok CLI、Kimi CLI、OpenCode CLI 和 ZCode 供应商。点击导入即可添加为网关供应商。",
      "Locked": "已加密",
